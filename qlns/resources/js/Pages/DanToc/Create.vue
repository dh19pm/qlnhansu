<template>
  <div>
    <h1 class="mb-8 font-bold text-3xl">
      <inertia-link class="text-indigo-400 hover:text-indigo-600" :href="route('chuyenmon')">Dân Tộc</inertia-link>
...
export default {
  metaInfo: { title: 'Thêm Mới Dân Tộc' },
  components: {
    LoadingButton,
    SelectInput,
    TextInput,
