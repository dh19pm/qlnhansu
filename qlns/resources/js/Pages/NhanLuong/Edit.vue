    ...
    <div class="bg-white rounded-md shadow overflow-hidden">
      <form @submit.prevent="update">
        <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
          ...
          <text-input v-model="form.khautru" :error="form.errors.khautru" class="pr-6 pb-8 w-full lg:w-1/2" label="Khẩu trừ" />
          ...
          <text-input v-model="form.thuclinh" :error="form.errors.thuclinh" class="pr-6 pb-8 w-full lg:w-1/2" type="number" label="Thực lĩnh" />
  ...
  data() {
    return {
      form: this.$inertia.form({
        ...
        phucap: this.nhanluong.phucap.toString(),
        khautru: this.nhanluong.khautru.toString(),
